...
from .routers.admin import production_thresholds as _r_admin_production_thresholds  # v1.40.6 — stage thresholds
...
from .routers import quote_document as _r_quote_document  # v1.47 Lane D
...
app.include_router(_r_admin_production_thresholds.router)  # v1.40.6 — stage thresholds CRUD
