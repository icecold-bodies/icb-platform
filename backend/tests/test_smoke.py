...
def test_mes_schema_tables():
    ...
    assert n == 41                                              # +chassis_models (0021); +production_jobs_audit (0023); +production_job_bay_events (0024); +feedback_submissions (v4.38 0027); +chassis_records_audit (v4.36.5 0029); +defect_categories/qc_inspections/qc_signoffs (v4.36c 0028); +plan_floor_state (Plan module, 0032)
