...
- Run: 2026-09-26T07:45:02+00:00 · tolerance 1.0 % · MES: in-process localhost/icb
...
- UP TO 5.5 CHILLER AND 2.3 WIDE · SUB FRAME + LIGHT BOX ASSY · [DATA] Burt's 1MM GALV PLATE line (R157-R240): missing from the MES BOM on CHILLER 2.3, CHILLER LARGE, FREEZER MEDIUM and the explosive bodies; CHILLER MEDIUM carries 1.2MM GALV PLATE at R449.52 (or, since 26 Sep on dev, a 1MM line at another price). — review by 2026-10-31 (6)
- icecream up to 4.8 · DRD · [DATA] icecream 4.8 door lines: 4MM PF PLYWOOD quantity, 28779 DOOR CAPPING (-R324), 3MM 3CR12 FLOOR PLATE (+R77.50) differ from Burt's sheet (2-6 % of the section) - see the triage. — review by 2026-10-31 (3)
