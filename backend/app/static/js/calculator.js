...
// The quote's for-attention-of person. Contacts load per selected customer;
// the primary contact (or a sole contact) auto-selects; "+" quick-adds inline
// so Nadie never leaves the quote to set up a contact.
